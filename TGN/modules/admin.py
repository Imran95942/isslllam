...
❂ /pinned*:* получение текущего прикрепленного сообщения.
...
❂ /unpin*:* удалить текущее сообщение, на которое был сделан вывод
❂ /invitelink*:* получить приглашение на ссылку
❂ /promote*:* продвигает пользователя, на сообщение которого ответили
❂ /fullpromote*:* продвигает пользователя, которому ответили, с полными правами
❂ /demote*:* понижает пользователя, которому ответили
❂ /title <title here>*:* устанавливает пользовательский заголовок для администратора, которого бот продвигал
❂ /admincache*:* принудительно обновляет список администраторов
...
❂ /setgtitle <текст>*:* устанавливает заголовок группы.
